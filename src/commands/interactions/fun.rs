        ...
        .send_message(ctx, |m| {
            m.embed(|e| {
                e.title("Password")
                    ...
                    .field("Generated by", msg.author.mention(), true)
                    .field("Generated in", msg.channel_id.mention(), true)
                    .field("Generated at", msg.timestamp.to_rfc3339(), true)
                    .field("Length", format!("{}", length), true)
                    .field("Generator", "pwdgen", true)
            })
        })
        .await?;
